   ...
   <?php if( get_field('bg') ): ?>
     <div class="uk-cover-background" style="background-image: url(<?php the_field('bg');?>">
       <?php if( have_rows('home') ): while( have_rows('home') ): the_row(); ?>
         <div class="uk-grid">
           <div class="uk-width-medium-1-3 flex-1">
             <div class="uk-scrollspy-init-inview uk-scrollspy-inview banner-text" data-uk-scrollspy="{cls: 'uk-animation-slide-top', delay:600}">
               <h1 class="leitmotif"><?php if( get_sub_field('header') ): the_sub_field('header'); endif; ?></h1>
             </div>
             <div class="uk-scrollspy-init-inview uk-scrollspy-inview banner-text" data-uk-scrollspy="{cls: 'uk-animation-fade', delay:1000}">
             <p class="leitmotif"><?php if( get_sub_field('subheader') ): the_sub_field('subheader'); endif; ?></p>
             </div>
           </div><!-- end first column -->

           <div class="uk-width-medium-1-3 flex-2">
