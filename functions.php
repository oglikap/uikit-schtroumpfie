...
function schtroumpfie_scripts() {
  wp_enqueue_style( 'main_css', get_template_directory_uri() . '/assets/css/uikit.min.css' );
  wp_enqueue_style( 'custom_css', get_template_directory_uri() . '/assets/css/custom.css' );
  wp_enqueue_style( 'slidenav_css', 'https://cdnjs.cloudflare.com/ajax/libs/uikit/2.27.5/css/components/slidenav.min.css' );
  wp_enqueue_style( 'slider_css', 'https://cdnjs.cloudflare.com/ajax/libs/uikit/2.27.5/css/components/slider.min.css' );
  wp_enqueue_style( 'dotnav_css', 'https://cdnjs.cloudflare.com/ajax/libs/uikit/2.27.5/css/components/dotnav.min.css' );
  wp_enqueue_script( 'uikit_js', 'https://cdnjs.cloudflare.com/ajax/libs/uikit/2.27.5/js/uikit.min.js', array( 'jquery' ), true );
  wp_enqueue_script( 'sticky', 'https://cdnjs.cloudflare.com/ajax/libs/uikit/2.27.5/js/components/sticky.min.js', true );
  wp_enqueue_script( 'grid', 'https://cdnjs.cloudflare.com/ajax/libs/uikit/2.27.5/js/components/grid.min.js', true );
  wp_enqueue_script( 'slider', 'https://cdnjs.cloudflare.com/ajax/libs/uikit/2.27.5/js/components/slider.min.js', true );
  wp_enqueue_script( 'slideset', 'https://cdnjs.cloudflare.com/ajax/libs/uikit/2.27.5/js/components/slideset.min.js', true );
  wp_enqueue_script( 'slideshow_js', 'https://cdnjs.cloudflare.com/ajax/libs/uikit/2.27.5/js/components/slideshow.min.js', true );
  wp_enqueue_script( 'lightbox_js', 'https://cdnjs.cloudflare.com/ajax/libs/uikit/2.27.5/js/components/lightbox.min.js', true );
//  wp_enqueue_script( 'slideshow', 'https://cdnjs.cloudflare.com/ajax/libs/uikit/2.27.5/css/components/slideshow.min.css', array( 'jquery' ), false );
//  wp_enqueue_script( 'slidenav', 'https://cdnjs.cloudflare.com/ajax/libs/uikit/2.27.5/css/components/slidenav.min.css', true );
}
